package com.transaction2datasource.transaction.job;
...
import com.transaction2datasource.transaction.model.Pessoa;
import com.transaction2datasource.transaction.utils.QueryUtils;
...
public class BatchConfig {
	...
	public ItemWriter<Pessoa> writer(@Qualifier("appDS") DataSource dataSource) {
		return new JdbcBatchItemWriterBuilder<Pessoa>()
				...
				.sql(QueryUtils.INSERT_INTO_PESSOA)
